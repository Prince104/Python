# -*- coding: utf-8 -*-
"""
Created on Sat Aug 21 14:26:09 2021
...
dataset = pd.read_csv('E:/ML/AEclass/50_Startups.csv')
...
S_Dummy.head(5)
#Concatenate these dummy var columns in our dataset.
...
#for fitting the model, we will create a lreg_OLS object of new class OLS of 
#statsmodels library. Then we will fit it by using the fit() method.
lreg_OLS=sm.OLS(endog = y, exog=x_opt).fit()
...
#importing datasets  
data_set = pd.read_csv('E:/ML/AEclass/50_Startups.csv') 
...
from sklearn.linear_model import LinearRegression
lreg = LinearRegression()
lreg.fit(x_BE_train, y_BE_train)

#Predicting the Test set result;
y_pred = lreg.predict(x_BE_test)
